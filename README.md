...
Ειδικότερα, το εκπαιδευτικό πρόγραμμα “Ο τελευταίος να σβήσει τα φώτα” θα εμπλέξει τουε μαθητές/τριες 
...
Στα παραπάνω ερωτήματα επιχειρεί να απαντήσει η διάταξη που προτείνουμε, η οποία αξιοποιώντας αισθητήρες κίνησης και έντασης φωτός σε συνεργασία με ένα μικρο-ελεγκτή (microbit ή raspberry pi zero) καταγράφει κατά τη διάρκεια ενός εικοσιτετραώρου τον χρόνο που παραμένουν αναμμένα τα φώτα σε μία σχολική αίθουσα (α) όταν δεν υπάρχει κανείς σε αυτή και (β) ή όταν ο φυσικός φωτισμός είναι επαρκής.
Διεύθυνση αποθετηρίου στο Github
Πληροφορίες του έργου θα βρείτε στον σύνδεσμο:
https://github.com/fkoutsakas/o-teleftaios-na-svisei-ta-fwta 

Λίστα προτεινόμενου εξοπλισμού
2 x BBC micro:bit V2 Board Go Bundle 2 x 22,50 ή εναλλακτικά \
...
3 suitable leads to connect it to a micro:bit κόστος 5 ευρώ
οθόνη LCD, ενδεικτική τιμή 20 ευρώ (παράδειγμα 1.8inch colorful display module for micro:bit, 160x128 ή εναλλακτικά Kitronik :VIEW text32 LCD Screen for the BBC micro bit)
Ενδεικτικό κόστος
